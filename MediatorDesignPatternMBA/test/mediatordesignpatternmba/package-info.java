/**
 * <p>This folder contains the test for the solution to the AJP first ICA which
 * requires to use the Mediator design pattern with the MBA case. Here are
 * tested the DroneConstruction Jedi RobotPressurizedRover and Scientist using
 * the mediator.</p>
 *
